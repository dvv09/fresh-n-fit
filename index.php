...
<html lang="en">
	<head>
		...
		<title>fnf CC - Welcome</title>
		<link rel="icon" href="index_files/favicon-32x32-icon.png">
		<!-- CSS FILES -->
		<link rel="stylesheet" type="text/css" href="index_files/uikit.css">

		<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
		<link rel="icon" type="index_files/image/png" sizes="32x32" href="index_file/favicon-32x32.png">
		<link rel="icon" type="image/png" sizes="16x16" href="index_file/favicon-16x16.png">
	...
	<body class="uk-flex uk-flex-center uk-flex-middle uk-background-muted uk-height-viewport" data-uk-height-viewport>
		<div class="uk-position-bottom-center uk-position-small uk-visible@m uk-position-z-index">
			<p class="uk-text-small uk-text-center">Design Algorithm, BSCS—SS191</a> | <img src="index_files/fnf-main.jpg" width="20px" /> fnf 2020</p>
		</div>
		<div class="uk-width-medium uk-padding-small">
			<div class="toggle-class" style="margin: auto auto; text-align: center; margin-bottom: 40px">
				<img src="index_files/fnf-main.jpg" style="width:250px" />
				<h1 class="uk-text-normal uk-text-secondary" style="margin: 0">fnf!</h1>
			</div>
			<!-- login -->
